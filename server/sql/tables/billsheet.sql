...
INSERT INTO `billsheet` VALUES
	(NULL,2,1,50,100,'1992-05-04',2,0,'','rec','rec1',3,'876',45,3,'#100','big dog'),
	(NULL,3,1,100,72,'1992-05-13',2,0,'','quux','rec2',8,'bbbb',50,2,'#3','fine description'),
	(NULL,2,2,200,100,'1992-05-04',2,0,'','foo','rec3',3,'876',45,3,'#100','big cat'),
	(NULL,3,2,300,72,'1992-05-13',2,0,'','bar','rec4',8,'bbbb',50,2,'#3','bad description');
